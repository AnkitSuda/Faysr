    ...
    implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    private boolean chooseContactForRingtone(MenuItem item){
        try {
            ...
            intent.setClassName(
                    "app.androidgrid",
            "app.androidgrid.faysr.editor.ChooseContactActivity");
    ...
    private void onRecord() {
        try {
            ...
            intent.setClassName( "app.faysr", "app.androidgrid.faysr.editor.RingdroidEditActivity");
...
//            startActivityForResult(intent, REQUEST_CODE_EDIT);
            ...
            args.putBoolean("was_get_content_intent", mWasGetContentIntent);
            args.putString("file", Uri.parse(filename).toString());

            Intent intent = new Intent(this, RingdroidEditActivity.class);
            //intent.putExtra("was_get_content_intent", mWasGetContentIntent);
            //intent.putExtra("file", Uri.parse(filename));
            intent.putExtras(args);
            startActivity(intent);
        } catch (Exception e) {
            Log.e("Ringdroid", "Couldn't start editor: " + e.toString());
        }
    }
