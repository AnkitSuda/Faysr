...
public class FaysrSongTrimActivity extends AppCompatActivity implements MarkerView.MarkerListener, WaveformView.WaveformListener {
    ...
    private TextView trimSave;
    private TextView trimReset;
    private TextView trimClose;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFilename = intent.getStringExtra("file").replace("file://", "").replaceAll("%20", "");
        mSoundFile = null;
        mKeyDown = false;
    ...
    private void loadGui() {
        ...
        trimSave = findViewById(R.id.trim_save);
        trimReset = findViewById(R.id.trim_reset);
        trimClose = findViewById(R.id.trim_close);
...
//        markEndButton.setOnClickListener(mMarkEndListener);
        ...
        trimSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onSave();
            }
        ...
        trimReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetPositions();
                mOffsetGoal = 0;
    ...
    private void loadFromFile() {
        ...
        mProgressDialog = new ProgressDialog(FaysrSongTrimActivity.this);
        ...
        mLoadSoundFileThread = new Thread() {
            public void run() {
                ...
                if (mLoadingKeepGoing) {
                    ...
                    FaysrSongTrimActivity.this.finish();
                }
            }
        };
    ...
    private void recordAudio() {
        ...
        mFinishActivity = false;
        AlertDialog.Builder adBuilder = new AlertDialog.Builder(FaysrSongTrimActivity.this);
...
//            mPlayButton.setContentDescription(getResources().getText(R.string.play));
    ...
    private void showFinalAlert(Exception e, CharSequence message) {
        ...
        new AlertDialog.Builder(FaysrSongTrimActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton(
    ...
    private void setUpPlayPauseButton() {
        ...
        mPlayButton.setColorFilter(R.color.md_black_1000, PorterDuff.Mode.SRC_IN);
        mPlayButton.setOnClickListener(mPlayListener);
        ...
        mPlayButton.post(new Runnable() {
            ...
            public void run() {
                if (mPlayButton != null) {
                    mPlayButton.setPivotX(mPlayButton.getWidth() / 2);
                    mPlayButton.setPivotY(mPlayButton.getHeight() / 2);
                }
            }
        });
    }
