package app.androidgrid.faysr.appshortcuts.shortcuttype;
...
import app.androidgrid.faysr.appshortcuts.AppShortcutLauncherActivity;
...
public abstract class BaseShortcutType {
    ...
    static final String ID_PREFIX = "app.androidgrid.faysr.appshortcuts.id.";
