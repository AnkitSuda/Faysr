package app.androidgrid.faysr.appshortcuts;

import android.app.Activity;
import android.content.Intent;
import android.os.Bundle;

import app.androidgrid.faysr.appshortcuts.shortcuttype.LastAddedShortcutType;
import app.androidgrid.faysr.appshortcuts.shortcuttype.ShuffleAllShortcutType;
import app.androidgrid.faysr.appshortcuts.shortcuttype.TopTracksShortcutType;
...
import app.androidgrid.faysr.model.smartplaylist.ShuffleAllPlaylist;
...
public class AppShortcutLauncherActivity extends Activity {
    public static final String KEY_SHORTCUT_TYPE = "app.androidgrid.faysr.appshortcuts.ShortcutType";
