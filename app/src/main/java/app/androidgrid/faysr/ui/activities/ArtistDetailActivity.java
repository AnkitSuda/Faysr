...
import app.androidgrid.faysr.adapter.album.HorizontalAlbumAdapter;
import app.androidgrid.faysr.adapter.song.ArtistSongAdapter;
import app.androidgrid.faysr.dialogs.AddToPlaylistDialog;
import app.androidgrid.faysr.dialogs.SleepTimerDialog;
import app.androidgrid.faysr.glide.ArtistGlideRequest;
...
import app.androidgrid.faysr.lastfm.rest.model.LastFmArtist;
import app.androidgrid.faysr.loader.ArtistLoader;
import app.androidgrid.faysr.misc.SimpleObservableScrollViewCallbacks;
...
public class ArtistDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
    ...
    private void loadArtistImage() {
        ArtistGlideRequest.Builder.from(Glide.with(this), artist)
                ...
                .dontAnimate()
                .into(new FaysrColoredTarget(artistImage) {
                    @Override
    ...
    public MaterialCab openCab(int menuRes, @NonNull final MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(this, R.id.cab_stub)
                ...
                .setBackgroundColor(FaysrColorUtil.shiftBackgroundColorForLightText(getPaletteColor()))
