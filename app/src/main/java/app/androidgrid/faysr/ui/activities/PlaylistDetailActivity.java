...
import app.androidgrid.faysr.adapter.song.OrderablePlaylistSongAdapter;
import app.androidgrid.faysr.adapter.song.PlaylistSongAdapter;
import app.androidgrid.faysr.adapter.song.SongAdapter;
import app.androidgrid.faysr.helper.MusicPlayerRemote;
import app.androidgrid.faysr.helper.menu.PlaylistMenuHelper;
...
import app.androidgrid.faysr.model.PlaylistSong;
...
public class PlaylistDetailActivity extends AbsSlidingMusicPanelActivity implements CabHolder, LoaderManager.LoaderCallbacks<ArrayList<Song>> {
    ...
    public MaterialCab openCab(final int menu, final MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(this, R.id.cab_stub)
                ...
                .setBackgroundColor(FaysrColorUtil.shiftBackgroundColorForLightText(ThemeStore.primaryColor(this)))
                .start(callback);
        return cab;
    }
