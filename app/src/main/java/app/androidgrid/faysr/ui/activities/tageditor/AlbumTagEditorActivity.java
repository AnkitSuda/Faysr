package app.androidgrid.faysr.ui.activities.tageditor;
...
import app.androidgrid.faysr.lastfm.rest.LastFMRestClient;
...
import app.androidgrid.faysr.util.ImageUtil;
import app.androidgrid.faysr.util.LastFMUtil;
...
public class AlbumTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    protected void loadCurrentImage() {
        ...
        setImageBitmap(bitmap, FaysrColorUtil.getColor(FaysrColorUtil.generatePalette(bitmap), ATHUtil.resolveColor(this, R.attr.defaultFooterColor)));
                        ...
                        Glide.with(AlbumTagEditorActivity.this)
                                ...
                                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                                    ...
                                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                                        ...
                                        setImageBitmap(albumArtBitmap, FaysrColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                                        deleteAlbumArt = false;
                                        dataChanged();
                                        setResult(RESULT_OK);
                                    }
    ...
    protected void loadImageFromFile(@NonNull final Uri selectedFileUri) {
        Glide.with(AlbumTagEditorActivity.this)
                ...
                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                    ...
                    @Override
                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                        FaysrColorUtil.getColor(resource.getPalette(), Color.TRANSPARENT);
                        albumArtBitmap = ImageUtil.resizeBitmap(resource.getBitmap(), 2048);
                        setImageBitmap(albumArtBitmap, FaysrColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                        deleteAlbumArt = false;
                        dataChanged();
