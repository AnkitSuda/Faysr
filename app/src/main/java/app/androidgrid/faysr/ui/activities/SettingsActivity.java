...
import app.androidgrid.faysr.misc.NonProAllowedColors;
import app.androidgrid.faysr.preferences.BlacklistPreference;
import app.androidgrid.faysr.preferences.BlacklistPreferenceDialog;
import app.androidgrid.faysr.preferences.NowPlayingScreenPreference;
import app.androidgrid.faysr.preferences.NowPlayingScreenPreferenceDialog;
          ...
          /*  final Preference defaultStartPage = findPreference("default_start_page");
            ...
            generalTheme.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, @NonNull Object o) {
                    ...
                    // Setting custom primary color (Just in case)
                    switch (themeName) {
                        case "light":
