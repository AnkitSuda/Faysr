...
import app.androidgrid.faysr.adapter.song.AlbumSongAdapter;
...
import app.androidgrid.faysr.ui.activities.tageditor.AlbumTagEditorActivity;
...
public class AlbumDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Album> {
    ...
    private void loadAlbumCover() {
        SongGlideRequest.Builder.from(Glide.with(this), getAlbum().safeGetFirstSong())
                ...
                .into(new FaysrColoredTarget(albumArtImageView) {
                    @Override
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_song_editor:
                Intent editorIntent = new Intent(this, RingdroidSelectActivity.class);
