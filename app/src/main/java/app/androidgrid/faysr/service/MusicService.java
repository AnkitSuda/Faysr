package app.androidgrid.faysr.service;
...
import app.androidgrid.faysr.appwidgets.AppWidgetBig;
import app.androidgrid.faysr.appwidgets.AppWidgetCard;
import app.androidgrid.faysr.appwidgets.AppWidgetClassic;
import app.androidgrid.faysr.appwidgets.AppWidgetSmall;
import app.androidgrid.faysr.glide.BlurTransformation;
import app.androidgrid.faysr.glide.SongGlideRequest;
import app.androidgrid.faysr.helper.ShuffleHelper;
import app.androidgrid.faysr.helper.StopWatch;
import app.androidgrid.faysr.loader.PlaylistSongLoader;
import app.androidgrid.faysr.model.AbsCustomPlaylist;
import app.androidgrid.faysr.model.Playlist;
import app.androidgrid.faysr.model.Song;
import app.androidgrid.faysr.provider.HistoryStore;
import app.androidgrid.faysr.provider.MusicPlaybackQueueStore;
import app.androidgrid.faysr.provider.SongPlayCountStore;
import app.androidgrid.faysr.service.notification.PlayingNotification;
import app.androidgrid.faysr.service.notification.PlayingNotificationImpl;
import app.androidgrid.faysr.service.notification.PlayingNotificationImpl24;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PHONOGRAPH_PACKAGE_NAME = "app.androidgrid.faysr";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("app.androidgrid.faysr.PHONOGRAPH_MUSIC_SERVICE_CREATED"));
    }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("app.androidgrid.faysr.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
