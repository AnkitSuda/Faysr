...
import app.androidgrid.faysr.helper.SortOrder;
...
public final class PreferenceUtil {
    ...
    public static final String TAB_ICONS = "tab_icons";
    ...
    public void setTabIcons(final boolean value) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putBoolean(TAB_ICONS, value);
        editor.apply();
    }

    public final boolean getTabIcons() {
        return mPreferences.getBoolean(TAB_ICONS, true);
    }
