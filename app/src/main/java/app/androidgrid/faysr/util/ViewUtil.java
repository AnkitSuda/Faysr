...
public class ViewUtil {
    ...
    public static Animator createColorFilterTransition(final View v, @ColorInt final int startColor, @ColorInt final int endColor) {
        return createColorAnimator(v, "colorFilter", startColor, endColor);
    }
